...
int main() {
    ...
    do
    {
        ...
        case 1:
            ...
            op.bookAppointment(oper, startTime, startTime+1, custName);
            cout << "\n \n*****************************************\n \n" << endl;
            break;
        ...
        case 2:
            ...
            op.rescheduleAppointment(oper, bookingid, startTime, startTime+1);
            cout << "\n \n*****************************************\n \n" << endl;
            break;
        ...
        case 3:
            ...
            cout << "enter your booking ID : ";
            cin >> bookingid;
            op.cancelAppointment(oper, bookingid);
            cout << "\n \n*****************************************\n \n" << endl;
            break;
